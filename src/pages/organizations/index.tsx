...
function OrganizationListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<OrganizationInterface[]>(
    ...
    () =>
      getOrganizations({
        relations: ['user', 'bill_payment.count', 'meter.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('meter', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>meter</Th>}
                  <Th>Actions</Th>
                </Tr>
              </Thead>
              <Tbody>
